...
class PostContent(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        my_response = validate_post_content(content)
        ...
        # For error response
        return Response(error_response("Post could not be created at this time."), status=HTTP_400_BAD_REQUEST)
